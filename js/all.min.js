...
$(document).ready(function(){upBtn=$(".up"),$(window).scroll(function(){$(this).scrollTop()>500?(upBtn.fadeIn(200),0===n&&(n=1,upBtn.children("img").attr("src","img/arrow-up.png"))):1===n&&upBtn.fadeOut(200)});var t,n=1;upBtn.on("click",function(){n?(t=$(window).scrollTop(),$(window).scrollTop(0),upBtn.children("img").attr("src","img/arrow-down.png"),n=0):($(window).scrollTop(t),upBtn.children("img").attr("src","img/arrow-up.png"),n=1)}),$(".wrapp-header ul li:eq(0)").on("click",function(){$("body, html").stop().animate({scrollTop:$(".why-we-content h2").offset().top-140+"px"},400)}),$(".wrapp-header ul li:eq(1)").on("click",function(){$("body, html").stop().animate({scrollTop:$(".how h2").offset().top-140+"px"},400)}),$(".wrapp-header ul li:eq(2)").on("click",function(){$("body, html").stop().animate({scrollTop:$(".wrapp-partners h2").offset().top-140+"px"},400)}),$(".wrapp-header ul li:eq(3)").on("click",function(){$("body, html").stop().animate({scrollTop:$(".wrapp-clients h2").offset().top-140+"px"},400)}),$(".wrapp-header ul li:eq(4)").on("click",function(){$("body, html").stop().animate({scrollTop:$(".wrapp-address h2").offset().top-140+"px"},400)}),$(".contentnav a:first").addClass("active");var e=$(".content-holder").width()+50,o=$(".element-slider").size()+20,c=e*o;$(".content-slider").css({width:c}),rotate=function(){var t=$active.attr("rel")-1,n=t*e;$(".contentnav a").removeClass("active"),$active.addClass("active"),$(".content-slider").stop().animate({left:-n},750)},rotation=function(){play=setInterval(function(){$active=$(".contentnav a.active").next(),0===$active.length&&($active=$(".contentnav a:first")),rotate()},5e3)},rotation(),$(".contentnav a").click(function(){return $active=$(this),clearInterval(play),rotate(),rotation(),!1}),$(".forwardSlide").on("click",function(){return clearInterval(play),$active=$(".contentnav a.active").next(),0===$active.length&&($active=$(".contentnav a:first")),rotate(),rotation(),!1}),$(".backSlide").on("click",function(){return clearInterval(play),$active=$(".contentnav a.active").prev(),"1"===$(".contentnav a.active").attr("rel")&&($active=$(".contentnav a").last()),rotate(),rotation(),!1}),unclickPoint=function(t){t.removeClass("btn-click")},clickPoint=function(t){t.addClass("btn-click")};var a=$(".facade-point li:eq(0)");clickPoint(a),$(".facade-point li").on("click",function(){unclickPoint(a),clickPoint($(this)),a=$(this)}),blockScroll=function(){document.onmousewheel=document.onwheel=function(){return!1},document.addEventListener("MozMousePixelScroll",function(){return!1},!1),document.onkeydown=function(t){return t.keyCode>=33&&t.keyCode<=40?!1:void 0}},unblockScroll=function(){document.onmousewheel=document.onwheel=function(){return!0},document.addEventListener("MozMousePixelScroll",function(){return!1},!0),document.onkeydown=function(t){return t.keyCode>=33&&t.keyCode<=40?!0:void 0}},$(".tel span, .btn-obr, .tel-footer span").on("click",function(){$(".wrapp-modal-form").fadeIn(200),blockScroll()}),$(".modal-form-cont img, .bg-modal-form").on("click",function(){$(".wrapp-modal-form").fadeOut(200),unblockScroll(),r=null}),$(".bg-modal-form").on("click",function(){$(".wrapp-obr").fadeOut(200),unblockScroll(),s=0,r=null}),$(".tel span, .btn-obr, .tel-footer span").on("click",function(){$(".wrapp-obr").fadeIn(200),blockScroll(),s=1}),$(".phone, #phone5").keypress(function(t){return 8!=t.which&&0!=t.which&&(t.which<48||t.which>57)?!1:void 0});var s=0;success=function(t,n){switch(blockScroll(),$(".wrapp-success").fadeIn(200),t){case 0:$(".success-head h3").text("Отзыв успешно отправлен!"),$(".success-text").html(n+"! Ваша заявка успешно отправлена,<br>в ближайшее время мы вам перезвоним."),$(".success-btn").css("display","block"),$(".error-btn").css("display","none");break;case 1:$(".success-head h3").text("Ваш вопрос отправлен!"),$(".success-text").html("В ближайшее время с Вами<br>свяжутся наши специалисты!"),$(".success-btn").css("display","block"),$(".error-btn").css("display","none");break;case 2:$(".success-head h3").text("Ваш телефон оптравлен!"),$(".success-text").html("В ближайшее время с Вами<br>свяжутся наши специалисты!"),$(".success-btn").css("display","block"),$(".error-btn").css("display","none")}},error=function(t){switch(blockScroll(),$(".wrapp-success").fadeIn(200),t){case 0:$(".success-head h3").text("Не все поля заполнены"),$(".success-head img").attr("src","img/warning.png"),$(".success-text").html("В данной форме все поля обязательны<br>для заполнения."),$(".success-btn").css("display","none"),$(".error-btn").css("display","block");break;case 1:$(".success-head h3").text("Не менее шести цифр"),$(".success-head img").attr("src","img/warning.png"),$(".success-text").html("Поле ввода телефона должно содержать<br>не менее 6-ти цифр"),$(".success-btn").css("display","none"),$(".error-btn").css("display","block")}},$(".success-btn").on("click",function(){$(".wrapp-success").fadeOut(200),s=0,unblockScroll(),r=null}),$(".error-btn").on("click",function(){$(".wrapp-success").fadeOut(200),0===s&&unblockScroll(),r=null}),$("input[type='submit']").click(function(t){t.preventDefault()});var r;$(".btn-obr").on("click",function(){var t=$(this).index(".btn-obr");r=t}),$(".button").click(function(){var t=$(this).index(".button"),n=$(".name:eq("+t+")").val(),e=$(".phone:eq("+t+")").val(),o=$(".button:eq("+t+")").val(),c=$(".phone:eq("+t+")").val().length,a=t;""==n||""==e?error(0):6>c?error(1):(0===t&&$(".wrapp-modal-form").fadeOut(200),null===r?$.ajax({url:"../mailScript/mail.php",type:"POST",data:{name:n,phone:e,button:o,form:a},success:function(e){e[0]?(success(0,n),$(".form:eq("+t+")").trigger("reset")):alert("Не отправлено")}}):($.ajax({url:"../mailScript/mailFacade.php",type:"POST",data:{name:n,phone:e,button:o,facadeCost:r},success:function(e){e[0]?(success(0,n),$(".form:eq("+t+")").trigger("reset")):alert("Не отправлено")}}),r=null))}),$("#btnQuestion").click(function(){var t=$("#mail").val(),n=$("#question").val(),e=$("#btnQuestion").val();""==t||""==n?error(0):$.ajax({url:"../mailScript/mailq1.php",type:"POST",data:{email:t,question:n,button:e},success:function(t){t[0]?(success(1),$("#formQuestion").trigger("reset")):alert("Не отправлено")}})}),$("#btnPhone").click(function(){var t=$("#phone5").val(),n=t.length,e=$("#btnPhone").val();""==t?error(0):6>n?error(1):$.ajax({url:"../mailScript/mailq2.php",type:"POST",data:{phone:t,button:e},success:function(t){t[0]?(success(2),$("#formPhone").trigger("reset")):alert("Не отправлено")}})});var i=1;$(".buttonShow").on("click",function(){1==i?($(".wrappQuestions").stop().animate({left:"0px"},200),$(".arrowQuestion").css("background-position","-15px 0px"),i=!i):($(".wrappQuestions").stop().animate({left:"-294px"},200),$(".arrowQuestion").css("background-position","0px 0px"),i=!i)});var l;$(".headerPunctQuestion").on("click",function(){var t=$(this).index(".headerPunctQuestion");null!=l&&(l.css("background",""),l.children("p").css("color","#000")),l=$(this).css("background","#006586"),l.children("p").css("color","#fff"),$(".inform:eq("+t+")").stop().slideToggle(100).siblings(".inform:visible").slideUp(100)});var u=$(".foto img:eq(0)"),p=$(".wrapp-block:eq(0)");$(".facade-point li").on("click",function(){var t=$(this).index(".facade-point li");u.css("display","none"),p.css("display","none"),u=$(".foto img:eq("+t+")").css("display","block"),p=$(".wrapp-block:eq("+t+")").css("display","block")})});
